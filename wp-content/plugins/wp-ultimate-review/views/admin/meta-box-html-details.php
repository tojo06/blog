...
<div class="xs-review-box details-xs-review wur-meta-box-container wur-login-main-wrapper" id="xs-review-box">
    ...
    <div id="xs_review_tr__2" class="wur-meta-main-content content-xs-review-box deactive_tr  <?php echo isset($saved_meta->overview->enable) ? 'active_tr' : ''; ?>">
        ...
        <div class="xs-wp-review-field wur-single-item">
            <div class="xs-wp-review-field-label">
                <label for="overview_average_enable"
                       class="wur-sec-title"><?php echo esc_html__('Enable author average', 'wp-ultimate-review'); ?></label>
            </div>
            <div class="xs-wp-review-field-option">
                <input class="review_switch_button" type="checkbox" id="overview_average_enable"
                       name="xs_review_overview_settings[overview][average][enable]"
                       value="Yes" <?php echo (isset($saved_meta->overview->average->enable) && $saved_meta->overview->average->enable == 'Yes') ? 'checked' : ''; ?> >
        ...
        <div class="xs-wp-review-field wur-single-item">
            <div class="xs-wp-review-field-label">
                <label for="user_rating_average_enable"
                       class="wur-sec-title"><?php echo esc_html__('Enable user rating average', 'wp-ultimate-review'); ?></label>
            </div>
            <div class="xs-wp-review-field-option">
                <input class="review_switch_button" type="checkbox" id="user_rating_average_enable"
                       name="xs_review_overview_settings[user_rating][average][enable]"
                       value="Yes" <?php echo (empty($saved_meta->user_rating->average->enable) ? '' : 'checked'); ?> >
                <label for="user_rating_average_enable" class="review_switch_button_label"></label>
            </div>
        </div>
