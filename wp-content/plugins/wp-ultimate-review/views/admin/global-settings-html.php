...
<div id="xs_settings" class="wur-login-main-wrapper">
    ...
    <div class="wur-main-header">
        <h1><span class="wur-icon wur wur-cog-icon1"></span><?php _e('WP Review Settings', 'wp-ultimate-review'); ?>
        </h1>
    </div>
                    ...
                    <div class="wur-single-item wur-single-item-middle">
                        <div class="wur-left-label">
                            <label for="reviw_require_login"
                                   class="wur-sec-title"><?php echo esc_html__('Restrict rating to registered users only ', 'wp-ultimate-review'); ?></label>
                        </div>
                        <div class="wur-right-content">
